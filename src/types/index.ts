 ...
 * Kinds: temp_gate_raise | temp_ev_relax | force_coverage_priority | revoke | …
 */
 ...
 * Progressive DeskStrip CFLOOR chip only — no client math.
 */
...
export interface CoverageHealth {
   ...
   * Optional — omit when not written; UI must not invent.
   */
  deep_target_n_effective?: number;
